...
function TextInput({ value, onChange, placeholder, className = '' }: {
  ...
  return (
    <input
      ...
      className={`bg-surface border border-border rounded-lg px-3 py-2 text-sm text-text-primary placeholder:text-text-muted/50 placeholder:italic focus:outline-none focus:border-accent transition-colors w-full ${className}`}
    />
  )
}
